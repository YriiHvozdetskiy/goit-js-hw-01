...
const howMuchDroidBuy = prompt('Cкільки дроїдів ви хочете купити?');

let totalPrice = 0;

if (howMuchDroidBuy === null) {
    console.log('Отменено пользователем!');
} else if ((totalPrice = pricePerDroid * Number(howMuchDroidBuy))) {
    if (totalPrice > credits) {
        console.log('Недостаточно средств на счету!');
    } else {
        let balance = credits - totalPrice;
        console.log(`Вы купили ${howMuchDroidBuy} дроидов, на счету осталось ${balance} кредитов.`);
    }
}
